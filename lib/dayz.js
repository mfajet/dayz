...
var Dayz = React.createClass({
    ...
    next: function next() {
        ...
        var range = moment.range(date.clone().startOf(props.display), date.clone().endOf(props.display));
        if (props.events) {
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(Nav, { date: this.props.date, next: this.next, prev: this.prev }),
